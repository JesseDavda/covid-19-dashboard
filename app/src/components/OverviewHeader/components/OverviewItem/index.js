    ...
    return (
        <Styled.ItemContainer>
            ...
            <Styled.NumberContainer>
                {title.toUpperCase() !== 'DECEASED'
                    ? <Styled.CaseNumber>{numberWithCommas(number)} - {numberWithCommas(newCasesNumber)} new</Styled.CaseNumber>
                    : <Styled.CaseNumber>{numberWithCommas(number)}</Styled.CaseNumber>}
                <Styled.Icon src={arrowSrc} alt="?" />
            </Styled.NumberContainer>
        </Styled.ItemContainer>
    )
}
